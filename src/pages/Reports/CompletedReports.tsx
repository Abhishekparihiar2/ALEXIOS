                ...
                <div className="relative">
                  <div 
                    ...
                    className={`flex items-center gap-2 px-3 py-1.5 border rounded-lg text-xs cursor-pointer transition-colors ${
                      isCalOpen || startDay ? 'bg-blue-50 border-blue-200 text-blue-700' : 'bg-slate-50 border-slate-200 text-slate-600 hover:bg-slate-100'
                    }`}
                  >
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50 text-[11px] font-bold text-slate-500 uppercase tracking-wider border-b border-slate-200 sticky top-0 z-10 shadow-sm dark:bg-slate-900 dark:text-slate-400 dark:border-slate-700">
                    ...
                    <th className="px-4 py-2.5">Checkpoints</th>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-[11px] font-bold ${
                          ...
                          tour.status === 'Incomplete' ? 'bg-red-100 text-red-700' :
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50 text-[11px] font-bold text-slate-500 uppercase tracking-wider border-b border-slate-200 sticky top-0 z-10 shadow-sm dark:bg-slate-900 dark:text-slate-400 dark:border-slate-700">
                    ...
                    <th className="px-4 py-2.5">Guard</th>
                    <th className="px-4 py-2.5">Client / Site</th>
                    <th className="px-4 py-2.5">Recorded At</th>
                    <th className="px-4 py-2.5">Related Record</th>
                    <th className="px-4 py-2.5">Duration / Size</th>
                    <th className="px-4 py-2.5 text-right">Actions</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50 text-[11px] font-bold text-slate-500 uppercase tracking-wider border-b border-slate-200 sticky top-0 z-10 shadow-sm dark:bg-slate-900 dark:text-slate-400 dark:border-slate-700">
                    ...
                    <th className="px-4 py-2.5">Guards</th>
                    <th className="px-4 py-2.5">Tours</th>
                    <th className="px-4 py-2.5">Reports</th>
                    <th className="px-4 py-2.5">Critical Events</th>
                    <th className="px-4 py-2.5">Status</th>
                    <th className="px-4 py-2.5 text-right">Actions</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                  {filteredSummaries.map(summary => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-[11px] font-bold ${
                          summary.status === 'Signed' ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'
                        }`}>
                          {summary.status}
                        </div>
                      </td>
                      <td className="px-4 py-3 text-right">
                        <button 
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-blue-700 bg-blue-50 border border-blue-200 hover:bg-blue-100 rounded-lg transition-colors shadow-sm"
