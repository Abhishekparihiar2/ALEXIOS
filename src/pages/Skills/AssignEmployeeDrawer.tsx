      ...
      >
        ...
        <div className="px-6 py-5 bg-white border-b border-slate-200 shrink-0 flex items-center justify-between sticky top-0 z-10">
          <div className="flex flex-col gap-1">
            <h2 className="text-xl font-bold text-slate-800">Assign Employee</h2>
            <p className="text-sm text-slate-500 leading-snug">
              Assign <span className="font-semibold text-slate-700">{skill?.name}</span> to an employee.
            </p>
          </div>
          <button 
            onClick={onClose}
          ...
          <div className="space-y-4 bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input 
                  ...
                  className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-slate-700"
                />
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <input 
                ...
                className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
              />
              <p className="text-xs text-slate-500">Employee-specific verification link.</p>
            </div>
            ...
            {skill?.requireDocument && (
              <div className="pt-2">
                <label className="text-sm font-semibold text-slate-700 flex flex-col gap-1">
                  ...
                  <span className="text-xs text-slate-500 font-normal">This skill requires a document to be uploaded.</span>
                </label>
                <div className="mt-2 border-2 border-dashed border-slate-300 rounded-lg p-6 flex flex-col items-center justify-center bg-slate-50 hover:bg-slate-100 transition-colors cursor-pointer">
