...
export function ActivityJournalPage() {
    ...
    return (
        <div className="w-full h-full flex flex-col animate-in fade-in bg-slate-50 min-w-0 overflow-hidden">
            <div className="p-[22px] md:px-[28px] md:py-[24px] w-full max-w-[1600px] mx-auto h-full flex flex-col min-w-0 min-h-0">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-4 mb-[26px] w-full shrink-0">
                    <div>
                        <h1 className="text-[32px] font-bold text-slate-900 tracking-tight leading-tight">Company Activity Journal</h1>
                        <p className="text-[15px] text-slate-500 mt-1">Audit logs for company-wide administrative actions.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-3 mb-5 shrink-0 w-full">
                    ...
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="w-full md:w-[320px] h-[42px] pl-9 pr-3 text-sm bg-white border border-[#DDE3EA] rounded-[10px] outline-none focus:border-[#1e3a8a] transition-colors shadow-sm" 
                        />
                    </div>
                ...
                {/* List Container */}
                <div className="bg-white border border-[#E4E8EE] rounded-[14px] overflow-hidden flex-1 flex flex-col min-h-0 min-w-0 w-full mb-2 shadow-sm" style={{ boxShadow: "0 2px 8px rgba(15, 23, 42, 0.03)" }}>
                    <div className="overflow-auto flex-1 min-h-0 relative">
                        {filteredJournal.length === 0 ? (
                            <div className="flex flex-col items-center justify-center h-full py-16 text-center">
                                ...
                                <h3 className="text-lg font-bold text-slate-900 mb-1">No activity found</h3>
