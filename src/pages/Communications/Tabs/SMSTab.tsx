          ...
          <tbody className="divide-y divide-slate-100">
            {MOCK_SMS.map(sms => (
              <tr key={sms.id} className="hover:bg-slate-50/50 transition-colors group">
                <td className="px-5 py-4 font-bold text-slate-800">{sms.recipient}</td>
                <td className="px-5 py-4 text-slate-600 font-medium">{sms.phone}</td>
                <td className="px-5 py-4 text-slate-600 max-w-xs truncate">{sms.message}</td>
                <td className="px-5 py-4 text-slate-500">{sms.sentBy}</td>
