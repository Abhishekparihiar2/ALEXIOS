      ...
      <div className="fixed top-0 right-0 bottom-0 w-full max-w-[500px] bg-slate-50 shadow-2xl z-40 flex flex-col animate-in slide-in-from-right duration-300">
        <div className="px-6 py-5 bg-white border-b border-slate-200 flex items-center justify-between shrink-0">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-slate-500">View message info and delivery stats.</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 no-scrollbar">
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4">
            <div className="flex items-start justify-between gap-4">
              <h3 className="font-bold text-lg text-slate-800">{broadcast.title}</h3>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-100">
              <div>
                <p className="text-xs font-semibold text-slate-500 mb-1">Sent By</p>
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm font-semibold text-slate-800">{broadcast.sentBy}</p>
                </div>
              </div>
              <div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4">
            <h4 className="font-bold text-slate-800">Message Content</h4>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-5">
            ...
            <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg border border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-800">{broadcast.audience}</p>
                  <p className="text-xs font-medium text-slate-500">Target Segment</p>
                </div>
              </div>
            </div>
            ...
            {broadcast.status === "Sent" && (
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <span className="font-semibold text-slate-600">Delivery Rate</span>
