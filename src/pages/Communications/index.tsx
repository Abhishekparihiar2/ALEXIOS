...
export function CommunicationsPage({ onNavigate }: CommunicationsPageProps) {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-transparent overflow-y-auto" style={{ scrollbarWidth: "none" }}>
      <PageHeader
          ...
          <div className="flex items-center gap-6 overflow-x-auto no-scrollbar mt-2">
            {tabs.map((tab) => (
              <button
                ...
                className={`flex items-center gap-2 pb-3 text-sm font-semibold transition-colors relative whitespace-nowrap ${activeTab === tab.id
      ...
      {/* Main Content Area */}
      <div className="flex-1 flex min-h-[850px]">
